...
static void init_pmu_cpu_option(void)
{
	...
	unsigned int tmp;
	void *chipid_base;
	unsigned int defect_core;

#ifndef PWRCAL_TARGET_LINUX
	chipid_base = (void *)0x10000000;
#else
	chipid_base = ioremap(0x10000000, SZ_64K);
#endif
	defect_core = (__raw_readl(chipid_base + 0x0004) >> 26) & 0xF;
