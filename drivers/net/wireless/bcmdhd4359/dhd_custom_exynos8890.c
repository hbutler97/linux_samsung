/*
 * Platform Dependent file for Samsung LSI Exynos8890
 *
 ...
 *
 * $Id: dhd_custom_exynos8890.c 618663 2016-02-12 01:40:45Z $
 */
...
dhd_wlan_power(int onoff)
{
	...
	if (!onoff) {
		exynos_pcie_poweroff(SLSI_PCIE_CH_NUM);
	}
...
{
	const char *wlan_node = "slsi,brcm-wlan";
