		...
		unsigned long action, void *data)
{
	 ...
	 */
	bq24190_write_mask(bdi, BQ24190_REG_ISC,
				BQ24190_REG_ISC_EN_HIZ_MASK,
				BQ24190_REG_ISC_EN_HIZ_SHIFT, 0x0);
	...
	case ATTACHED_DEV_JIG_USB_ON_MUIC:
		if (action == MUIC_NOTIFY_CMD_DETACH){
			dev_info(bdi->dev,"detached USB\n");
			bq24190_write_mask(bdi, BQ24190_REG_ISC,
						BQ24190_REG_ISC_IINLIM_MASK,
						BQ24190_REG_ISC_IINLIM_SHIFT, 0x0);
		}
		else if (action == MUIC_NOTIFY_CMD_ATTACH){
			dev_info(bdi->dev,"attached USB\n");
			bq24190_write_mask(bdi, BQ24190_REG_ISC,
						BQ24190_REG_ISC_IINLIM_MASK,
						BQ24190_REG_ISC_IINLIM_SHIFT, 0x2);
		}
		break;
...
static const struct dev_pm_ops bq24190_pm_ops = {
	.suspend_late = bq24190_pm_suspend,
	.resume_early = bq24190_pm_resume,
};
