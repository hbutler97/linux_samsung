...
struct exynos_drm_private {
	...
	struct exynos_drm_gem_private *gem_priv;
...
extern struct platform_driver exynos_decon_driver;
extern struct platform_driver exynos_vpp_driver;
extern struct platform_driver exynos_decon_t_driver;
