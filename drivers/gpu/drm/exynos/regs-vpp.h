/* linux/drivers/gpu/drm/exynos-hq/regs-vpp.h
 *
...
#define IDMA_COLOR_FILL_EN			(0x0A58)
#define F_COLOR_FILL_EN				(0x0)
#define IDMA_FILL_COLOR				(0x0A5C)
#define COLOR_A(x)				((a >> 24) & 0xFF)
#define COLOR_R(x)				((a >> 16) & 0xFF)
#define COLOR_G(x)				((a >>  8) & 0xFF)
#define COLOR_B(x)				((a >>  0) & 0xFF)

/* IDMA_VG(R)x Color Fill Enable */
#define VG_COLOR_FILL_ENABLE			(0xA58)

#define VG_COLOR_FILL_EN			(1 << 0)

/* IDMA_VG(R)x Fill Color Component */
#define VG_FILL_COLOR				(0xA5C)

#define VG_FILL_COLOR_ALPHA_MASK		(0xFF << 24)
#define VG_FILL_COLOR_ALPHA(x)			((x) << 24)
#define VG_FILL_COLOR_RED_MASK			(0xFF << 16)
#define VG_FILL_COLOR_RED(x)			((x) << 16)
#define VG_FILL_COLOR_GREEN_MASK		(0xFF << 8)
#define VG_FILL_COLOR_GREEN(x)			((x) << 8)
#define VG_FILL_COLOR_BLUE_MASK			(0xFF << 0)
#define VG_FILL_COLOR_BLUE(x)			((x) << 0)
