...
int fimc_is_ssxvc1_video_probe(void *data)
{
	...
	switch(instance) {
	case 0:
		video_name = FIMC_IS_VIDEO_SSXVC1_NAME(0);
		video_id = FIMC_IS_VIDEO_SS0VC1_NUM;
		break;
	case 1:
		video_name = FIMC_IS_VIDEO_SSXVC1_NAME(1);
		video_id = FIMC_IS_VIDEO_SS1VC1_NUM;
		break;
	case 2:
		video_name = FIMC_IS_VIDEO_SSXVC1_NAME(2);
		video_id = FIMC_IS_VIDEO_SS2VC1_NUM;
		break;
	case 3:
		video_name = FIMC_IS_VIDEO_SSXVC1_NAME(3);
		video_id = FIMC_IS_VIDEO_SS3VC1_NUM;
		break;
	default:
