...
int fimc_is_ssxvc0_video_probe(void *data)
{
	...
	switch(instance) {
	case 0:
		video_name = FIMC_IS_VIDEO_SSXVC0_NAME(0);
		video_id = FIMC_IS_VIDEO_SS0VC0_NUM;
		break;
	case 1:
		video_name = FIMC_IS_VIDEO_SSXVC0_NAME(1);
		video_id = FIMC_IS_VIDEO_SS1VC0_NUM;
		break;
	case 2:
		video_name = FIMC_IS_VIDEO_SSXVC0_NAME(2);
		video_id = FIMC_IS_VIDEO_SS2VC0_NUM;
		break;
	case 3:
		video_name = FIMC_IS_VIDEO_SSXVC0_NAME(3);
		video_id = FIMC_IS_VIDEO_SS3VC0_NUM;
		break;
	default:
