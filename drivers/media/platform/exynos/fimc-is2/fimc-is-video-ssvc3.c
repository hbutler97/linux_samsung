...
int fimc_is_ssxvc3_video_probe(void *data)
{
	...
	switch(instance) {
	case 0:
		video_name = FIMC_IS_VIDEO_SSXVC3_NAME(0);
		video_id = FIMC_IS_VIDEO_SS0VC3_NUM;
		break;
	case 1:
		video_name = FIMC_IS_VIDEO_SSXVC3_NAME(1);
		video_id = FIMC_IS_VIDEO_SS1VC3_NUM;
		break;
	case 2:
		video_name = FIMC_IS_VIDEO_SSXVC3_NAME(2);
		video_id = FIMC_IS_VIDEO_SS2VC3_NUM;
		break;
	case 3:
		video_name = FIMC_IS_VIDEO_SSXVC3_NAME(3);
		video_id = FIMC_IS_VIDEO_SS3VC3_NUM;
		break;
	default:
