...
#define EXYNOS_REG_PMU_BASE		(0x105C0000)
#define EXYNOS_REG_GPIO_PERIC0		(0x136D0000)
#define EXYNOS_REG_CMU_TOP_BASE		(0x10570000)
#define EXYNOS_REG_CMU_CAM0_BASE	(0x144D0000)
#define EXYNOS_REG_PMU_CAM0_BASE	(0x144E0000)
#define EXYNOS_REG_SYSREG_CAM0		(0x144F0000)

#define FIMC_IS_REG_MIPI_CSI0		(0x14000000)
#define FIMC_IS_REG_MIPI_CSI1		(0x14010000)
#define FIMC_IS_REG_FIMC_BNS_A		(0x14020000)
#define FIMC_IS_REG_FIMC_3AA0		(0x14050000)
#define FIMC_IS_REG_FIMC_3AA1		(0x14060000)
#define FIMC_IS_REG_MIPI_CSI2		(0x14100000)
#define FIMC_IS_REG_MIPI_CSI3		(0x14110000)
#define FIMC_IS_REG_FIMC_MC_SCALER	(0x14120000)
#define FIMC_IS_REG_FIMC_VRA_SET_A	(0x14130000)
#define FIMC_IS_REG_FIMC_VRA_SET_B	(0x14140000)
#define FIMC_IS_REG_FIMC_TPU		(0x14220000)
#define FIMC_IS_REG_FIMC_ISP0		(0x14230000)
#define FIMC_IS_REG_FIMC_ISP1		(0x142A0000)
#define FIMC_IS_REG_FIMC_MCUCTL_ISP	(0x14370000)

#define SYSMMU_REG_ISPCPU		(0x141D0000)
#define SYSMMU_REG_VRA			(0x141C0000)
#define SYSMMU_REG_IS_A			(0x140E0000)
#define SYSMMU_REG_IS_B			(0x141E0000)
#define SYSMMU_REG_MC_SCALER		(0x141B0000)
#define SYSMMU_REG_IS_C			(0x14280000)
