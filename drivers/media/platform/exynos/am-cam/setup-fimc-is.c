...
int exynos8895_fimc_is_print_clk(struct device *dev)
{
	fimc_is_get_rate(dev, "GATE_ISP_EWGEN_ISPHQ");
	fimc_is_get_rate(dev, "GATE_IS_ISPHQ_3AA");
	fimc_is_get_rate(dev, "GATE_IS_ISPHQ_ISPHQ");
	fimc_is_get_rate(dev, "GATE_IS_ISPHQ_QE_3AA");
	fimc_is_get_rate(dev, "GATE_IS_ISPHQ_QE_ISPHQ");
	fimc_is_get_rate(dev, "GATE_ISPHQ_CMU_ISPHQ");
	fimc_is_get_rate(dev, "GATE_PMU_ISPHQ");
	fimc_is_get_rate(dev, "GATE_SYSREG_ISPHQ");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_ISPHQ_BUS");

	fimc_is_get_rate(dev, "GATE_ISP_EWGEN_ISPLP");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_3AAW");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_ISPLP");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_QE_3AAW");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_QE_ISPLP");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_SMMU_ISPLP");
	fimc_is_get_rate(dev, "GATE_IS_ISPLP_BCM_ISPLP");
	fimc_is_get_rate(dev, "GATE_BTM_ISPLP");
	fimc_is_get_rate(dev, "GATE_ISPLP_CMU_ISPLP");
	fimc_is_get_rate(dev, "GATE_PMU_ISPLP");
	fimc_is_get_rate(dev, "GATE_SYSREG_ISPLP");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_ISPLP_BUS");

	fimc_is_get_rate(dev, "GATE_ISP_EWGEN_CAM");
	fimc_is_get_rate(dev, "GATE_IS_CAM_CSIS0");
	fimc_is_get_rate(dev, "GATE_IS_CAM_CSIS1");
	fimc_is_get_rate(dev, "GATE_IS_CAM_CSIS2");
	fimc_is_get_rate(dev, "GATE_IS_CAM_CSIS3");
	fimc_is_get_rate(dev, "GATE_IS_CAM_MC_SCALER");
	fimc_is_get_rate(dev, "GATE_IS_CAM_CSISX4_DMA");
	fimc_is_get_rate(dev, "GATE_IS_CAM_SYSMMU_CAM0");
	fimc_is_get_rate(dev, "GATE_IS_CAM_SYSMMU_CAM1");
	fimc_is_get_rate(dev, "GATE_IS_CAM_BCM_CAM0");
	fimc_is_get_rate(dev, "GATE_IS_CAM_BCM_CAM1");
	fimc_is_get_rate(dev, "GATE_IS_CAM_TPU0");
	fimc_is_get_rate(dev, "GATE_IS_CAM_VRA");
	fimc_is_get_rate(dev, "GATE_IS_CAM_QE_TPU0");
	fimc_is_get_rate(dev, "GATE_IS_CAM_QE_VRA");
	fimc_is_get_rate(dev, "GATE_IS_CAM_BNS");
	fimc_is_get_rate(dev, "GATE_IS_CAM_QE_CSISX4");
	fimc_is_get_rate(dev, "GATE_IS_CAM_QE_TPU1");
	fimc_is_get_rate(dev, "GATE_IS_CAM_TPU1");
	fimc_is_get_rate(dev, "GATE_BTM_CAMD0");
	fimc_is_get_rate(dev, "GATE_BTM_CAMD1");
	fimc_is_get_rate(dev, "GATE_CAM_CMU_CAM");
	fimc_is_get_rate(dev, "GATE_PMU_CAM");
	fimc_is_get_rate(dev, "GATE_SYSREG_CAM");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_CAM_BUS");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_CAM_TPU0");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_CAM_VRA");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_CAM_TPU1");

	fimc_is_get_rate(dev, "GATE_DCP");
	fimc_is_get_rate(dev, "GATE_BTM_DCAM");
	fimc_is_get_rate(dev, "GATE_DCAM_CMU_DCAM");
	fimc_is_get_rate(dev, "GATE_PMU_DCAM");
	fimc_is_get_rate(dev, "GATE_BCM_DCAM");
	fimc_is_get_rate(dev, "GATE_SYSREG_DCAM");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_DCAM_BUS");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_DCAM_IMGD");

	fimc_is_get_rate(dev, "GATE_SRDZ");
	fimc_is_get_rate(dev, "GATE_BTM_SRDZ");
	fimc_is_get_rate(dev, "GATE_PMU_SRDZ");
	fimc_is_get_rate(dev, "GATE_BCM_SRDZ");
	fimc_is_get_rate(dev, "GATE_SMMU_SRDZ");
	fimc_is_get_rate(dev, "GATE_SRDZ_CMU_SRDZ");
	fimc_is_get_rate(dev, "GATE_SYSREG_SRDZ");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_SRDZ_BUS");
	fimc_is_get_rate(dev, "UMUX_CLKCMU_SRDZ_IMGD");

	fimc_is_get_rate(dev, "MUX_CIS_CLK0");
	fimc_is_get_rate(dev, "MUX_CIS_CLK1");
	fimc_is_get_rate(dev, "MUX_CIS_CLK2");
	fimc_is_get_rate(dev, "MUX_CIS_CLK3");

	fimc_is_get_rate(dev, "CIS_CLK0");
	fimc_is_get_rate(dev, "CIS_CLK1");
	fimc_is_get_rate(dev, "CIS_CLK2");
	fimc_is_get_rate(dev, "CIS_CLK3");
