...
#ifndef __S5K4EC_SOC_REG_2560x1440_H
#define __S5K4EC_SOC_REG_2560x1440_H

#define ARR_SIZE(a) (sizeof(a) / sizeof((a)[0]))

uint32_t s5k4ec_reg_2560x1440[] = {
	//==================================================================================
	//02.ETC Setting
	//==================================================================================
	...
	//========,==========================================================================
	// 03.Anal,og Setting & ASP Control
	//========,==========================================================================

	//This reg,ister is for FACTORY ONLY.
	//If you c,hange it without prior notification
	...
	// Total S,ize 2916 (0B64)
	// Addr : ,3AF8  Size : 2914(B62h)

	// TNP_USE,R_MBCV_CONTROL
	// TNP_4EC,_MBR_TUNE
	// TNP_4EC,_FORBIDDEN_TUNE
	// TNP_AF_,FINESEARCH_DRIVEBACK
	// TNP_FLA,SH_ALG
	// TNP_GAS,_ALPHA_OTP
	// TNP_AWB,_MODUL_COMP
	// TNP_AWB,_INIT_QUEUE
	// TNP_AWB,_GRID_LOWBR
	// TNP_AWB,_GRID_MODULECOMP
	// TNP_ADL,C_TUNE
	// TNP_1FR,AME_AE
	// TNP_TG_,OFF_CFG_CHG_IN_SPOOF_MODE
	...
	//========,==========================================================================
	//04.Gas_A,nti Shading_Otp
	//========,==========================================================================
	0x00287000,
	0x002A08B4,
	0x0F120001,       //wbt_bUseOutdoorASH

	// Refer M,on_AWB_RotGain
	0x002A08BC,
	...
	//========,==========================================================================
	// 07. Ana,log Setting 2
	//========,==========================================================================
	//This reg,ister is for FACTORY ONLY.
	//If you c,hange it without prior notification
	//YOU are ,RESPONSIBLE for the FAILURE that will happen in the future
	//For subs,ampling Size
	...
	//========,==========================================================================
	// 10.Cloc,k Setting                          PCLK  X
	//========,==========================================================================

	//Input Cl,ock (Mclk)
	0x002A01F8,
	0x0F125DC0, //6590	//REG_TC_IPRM_InClockLSBs
	0x002A0212,
	0x0F120000,	//REG_TC_IPRM_UseNPviClocks
	0x0F120002,	//REG_TC_IPRM_UseNMipiClocks
	0x0F120002,	//REG_TC_IPRM_NumberOfMipiLanes

	//System C,lock & Output clock (Pclk)
	0x002A021A,
	0x0F124F1A,	//REG_TC_IPRM_OpClk4KHz_0 //SCLK : 60Mhz
	0x0F124F1A, //2904	//REG_TC_IPRM_MinOutRate4KHz_0
	0x0F12501A, //29FE	//REG_TC_IPRM_MaxOutRate4KHz_0
	...
	//ae_StatM,ode bit[3] BLC has to be bypassed to prevent AE weight change especially backlight scene //
	0x002A148A,
	...
	0x0F120A00, //A10 //0A10	//REG_0TC_PCFG_usWidth
	0x0F1205A0, //78C //078C	//REG_0TC_PCFG_usHeight
	0x0F120001, //0005	//REG_0TC_PCFG_Format //1:RGB888} 5:YUV} 7:RAW} 9:JPEG
	0x0F12501A, //29FE	//REG_0TC_PCFG_usMaxOut4KHzRate
	0x0F124F1A, //2904	//REG_0TC_PCFG_usMinOut4KHzRate
	0x0F120100, //0100	//REG_0TC_PCFG_OutClkPerPix88
	0x0F120300, //0300	//REG_0TC_PCFG_uBpp88
	0x0F120012, //0012	//REG_0TC_PCFG_PVIMask //[1]:PCLK Inversion
	0x0F120070, //0000	//REG_0TC_PCFG_OIFMask
	0x0F120810, //01E0	//REG_0TC_PCFG_usJpegPacketSize
	0x0F120900, //0000	//REG_0TC_PCFG_usJpegTotalPackets
	0x0F120000, //0000	//REG_0TC_PCFG_uClockInd
	0x0F120000, //0000	//REG_0TC_PCFG_usFrTimeType
	0x0F120002, //0001	//REG_0TC_PCFG_FrRateQualityType
	0x0F12029A, //0535	//REG_0TC_PCFG_usMaxFrTimeMsecMult10 //03E8h:10fps
	0x0F12029A, //029A //0535	//REG_0TC_PCFG_usMinFrTimeMsecMult10 //014Ah:30fps
	0x002A02D0,
	...
	//========,===================================================
	// 21.Sele,ct Cofigration Display
	//========,===================================================
	0x00287000,
	0x002A0266,
...
struct s5k4ec_reg s5k4ec_reg_set_2560x1440 = {
	.reg = s5k4ec_reg_2560x1440,
	.size = ARR_SIZE(s5k4ec_reg_2560x1440)
};
