					...
					void *priv, void (*release)(void *priv))
{
	...
	buffer->dmabuf_priv = priv;

	return dmabuf;
}
EXPORT_SYMBOL(ion_share_dma_buf_callback);
...
EXPORT_SYMBOL(__ion_import_dma_buf);
...
struct ion_handle *ion_import_dma_buf(struct ion_client *client, int fd)
{
	...
	handle = __ion_import_dma_buf(client, dmabuf);
